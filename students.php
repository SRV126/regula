 ...
 */
    ...
    class studentsPage extends Page
    {
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            $column->SetFullTextWindowHandlerName('studentsGrid_name_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('studentsGrid_name_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        protected function AddPrintColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('studentsGrid_name_handler_print');
            $grid->AddPrintColumn($column);
        ...
        protected function AddExportColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('studentsGrid_name_handler_export');
            $grid->AddExportColumn($column);
        ...
        private function AddCompareColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('studentsGrid_name_handler_compare');
            $grid->AddCompareColumn($column);
        ...
        protected function doRegisterHandlers() {
            ...
            $column = new TextViewColumn('name', 'name', 'Name', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'studentsGrid_name_handler_list', $column);
            ...
            $column = new TextViewColumn('name', 'name', 'Name', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'studentsGrid_name_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);
    ...
    try
    {
        $Page = new studentsPage("students", "students.php", GetCurrentUserPermissionSetForDataSource("students"), 'UTF-8');
        $Page->SetTitle('Students');
        $Page->SetMenuLabel('Students');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("students"));
